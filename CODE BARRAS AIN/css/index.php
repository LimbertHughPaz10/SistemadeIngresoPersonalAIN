...
<html>
    <head>
	  ...
	  <title>Sistema de Ingreso | Log in</title>
       ...
       <div class="container" style="margin-top:5%"> 
		   <div class="wrapper">
            <div class="row">
				...
				<div class="col-md-6">
				<h3 style="color:#fff">GESTIÓN DE ASISTENCIA DE EMPLEADOS CB.</h3>
				</div>
                <div class="col-md-6">
				...
				<div class="container-fluid">
					...
					<li><a href="attendance.php"> <span class="glyphicon glyphicon-calendar"></span> Reporte</a></li>
					</ul>
				</div>
				</nav>
				<form action="TimeInOut.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                    ...
                    <input type="text" name="empleadoID" id="text" placeholder="Escanear Codigo de Barra" class="form-control" autofocus>
					
                </form>
				 <div class="row">
						<div class="col-md-12">
						 <label style="color:#fff">Etiquetas habiles: </label>
