...
<html>
    <head>
	  ...
	  <title>SISTEMA DE INGRESO DE PERSONAL CODE-BAR</title>
        ...
        <nav class="navbar" style="background:#fff">
		  <div class="container-fluid">
			<div class="navbar-header">
			  <a class="navbar-brand" href="#">Sistema de registro de personal</a>
			</div>
			<ul class="nav navbar-nav">
			  ...
			  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-cog"></span> Mantenimiento <span class="caret"></span></a>
				<ul class="dropdown-menu">
				  ...
				  <li><a href="#"><span class="glyphicon glyphicon-plus-sign"></span> Nuevo Personal</a></li>
			   ...
			   <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if($conn->connect_error){
                           ...
                           $sql ="SELECT * FROM attendance LEFT JOIN used ON attendance.USEDID=used.USEDID";
                           $query = $conn->query($sql);
                           while ($row = $query->fetch_assoc()){
                        ?>
                            <tr>
                                <td><?php echo $row['LASTNAME'].', '.$row['FIRSTNAME'].' '.$row['MNAME'];?></td>
                                <td><?php echo $row['USEDID'];?></td>
